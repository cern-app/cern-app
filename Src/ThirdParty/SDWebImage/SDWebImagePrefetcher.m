...
{
    _finishedCount++;
    NSLog(@"Prefetched %lu out of %d", (unsigned long)_finishedCount, [self.prefetchURLs count]);
...
{
    _finishedCount++;
    NSLog(@"Prefetched %lu out of %d (Failed)", (unsigned long)_finishedCount, [self.prefetchURLs count]);
