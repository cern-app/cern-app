...
@property (nonatomic, weak) NSObject<PhotoBrowserProtocol> *photoBrowser;
...
- (void) layoutSubviews
{
	...
	// Spinner
	if (!_spinner.hidden)
      _spinner.center = CGPointMake(floorf(self.bounds.size.width / 2.f),
...
{
#pragma unused(scrollView, decelerate)
...
- (void) handleDoubleTap : (CGPoint) touchPoint
{
   ...
   [NSObject cancelPreviousPerformRequestsWithTarget : _photoBrowser];
	...
	if (self.zoomScale == self.maximumZoomScale) {
		...
		// Zoom in
		[self zoomToRect : CGRectMake(touchPoint.x, touchPoint.y, 1.f, 1.f) animated : YES];
	}
